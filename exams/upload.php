...
$upload_dir = "/var/myuploads/"; // Directory for file storing
                                            // filesystem path
...
if (isset($_POST['fileframe'])) 
{
	...
	$examtype=$_SESSION['examtype']  ;
            ...
            $filename = "$course_code"."_"."$examtype"."_"."$yearofexam"."_"."$prof_name"."."."$extension";
            $query="INSERT into exam_file_data(prof_name,department,course,yearofstudy,yearofexam,examtype,filename,extension) VALUES('$prof_name','$department','$course_code','$yearofstudy','$yearofexam','$examtype','$filename','$extension')";
            mysql_query($query);
...
function jsUpload(upload_field)
{
    ...
    var re_text = /\.txt|\.xml|\.zip|\.png|\.bmp|\.jpeg|\.pdf|\.jpg/i;
