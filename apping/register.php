...
if (isset($_POST['register']))
{
	...
	{
		register_user($username,$fullname,$department,$email,$alt_email,$mobile,$cpi,$gre);
...
<title>UG Academics | Register</title>
<style>
...
<tr><td>CPI</td><td><input type='text' name='cpi'></td></tr>
<tr><td>GRE Score</td><td><input type='text' name='gre'></td></tr>
<tr><td><input type="submit" class="button" name='register' value="Register" onClick="return validate(fform)"/></td></tr>
 ...
 <ul id="navigation">
            ...
            <li class="search"><a href="" title="Search For Universities"></a></li>
...
UG Academics Web Team © 2012. All rights reserved
  ...
  <script type="text/javascript">
           /* $(function() {
			...
			function validatecpi(field){
				if (field =="") return "No Year entered. \n"
				return ""
			}
			function validategre(field){
            ...
            function validate(form)
            {
				...
				fail+=validatehostel(form.gre.value)
				fail+=validateroom(form.cpi.value)
